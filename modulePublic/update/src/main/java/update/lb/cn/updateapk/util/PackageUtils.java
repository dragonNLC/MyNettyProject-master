...
public class PackageUtils {
    ...
    public static int installSilent(Context context, String filePath,
         ...
         **/
        String commandStr = "";
        if (CPUArchitecture.CPU_ARCHITECTURE_TYPE_32.equals(CPUArchitecture.getArchType())) {
            commandStr = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install ";
        } else {
            commandStr = "LD_LIBRARY_PATH=/vendor/lib64:/system/lib64 pm install ";
        }
    ...
    public static int uninstallSilent(Context context, String packageName,
        ...
        String commandStr = "";
        if (CPUArchitecture.CPU_ARCHITECTURE_TYPE_32.equals(CPUArchitecture.getArchType())) {
            commandStr = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm uninstall";
        } else {
            commandStr = "LD_LIBRARY_PATH=/vendor/lib64:/system/lib64 pm uninstall";
        }
        StringBuilder command = new StringBuilder()
                .append(commandStr)
                .append(isKeepData ? " -k " : " ")
     ...
     *
     * @return IPackageManager#getInstallLocation()
     */
    public static int getInstallLocation() {
        String command = "";
        if (CPUArchitecture.CPU_ARCHITECTURE_TYPE_32.equals(CPUArchitecture.getArchType())) {
            command = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm get-install-location";
        } else {
            command = "LD_LIBRARY_PATH=/vendor/lib64:/system/lib64 pm get-install-location";
        }
